...
userSchema = new Schema({
    email: {
        ...
        unique: true,
        validate: [{
            validator: EmailArrayFormatValidator,
            msg: '请输入您的邮箱地址'
        }, {
            validator: buildUniqueValidator('email'),
            msg: '这个邮箱已经被注册了'
        }]
    },
    mobile: {
        ...
        unique: true,
        validate: [{
            validator: MobileArrayFormatValidator,
            msg: '请输入您的手机号'
        }, {
            validator: buildUniqueValidator('mobile'),
            msg: '这个手机已经被注册了'
        }]
    },
    username: {
...
userSchema.statics.ValidateCookie = function (req, res, next) {
    var log = new AccessLog({
        ...
        userid: '',
        static: staticPath.test(req.originalUrl)
    });
